...
export default function Submitdoc1() {
    return (
        ...
        <ul className=" space-y-2 font-medium  border-gray-200 dark:border-gray-700">
          ...
          <li>
            ...
            <div class="bg-white shadow-lg rounded-lg p-8 w-[1200px] ml-[500px] mt-[200px]  ">
                <h1 class="text-2xl font-bold text-gray-700 mb-2">New Document</h1>
                <p class="text-gray-500 mb-6">Create your documents</p>

                <form>
                <div class="mb-4">
                    <label for="document-name" class="block text-sm font-medium text-gray-700">Document Name <span class="text-red-500">*</span></label>
                    <input
                    type="text"
                    id="document-name"
                    ...
                    value="Working Contract"
                    />
                </div>

                <div class="mb-4">
                    <label for="document-type" class="block text-sm font-medium text-gray-700">Type <span class="text-red-500">*</span></label>
                    <input
                    type="text"
                    id="document-type"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500"
                ...
                <div class="flex justify-end">
                    <button
                    type="submit"
                    class="px-6 py-2 bg-teal-500 text-white font-semibold rounded-md shadow hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500"
                    >
                        <a href="Submitdoc2">Continue</a>
                    </button>
                </div>
                </form>
            </div>
