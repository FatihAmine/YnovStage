    ...
    return (
        ...
        <ul className=" space-y-2 font-medium  border-gray-200 dark:border-gray-700">
          ...
          <li>
            ...
            <div className="w-[1400px] h-[700px] shadow-lg p-4 flex flex-col items-center  ml-[400px] mt-[80px] ">
                <h1 className="font-bold text-[20px]">Année universitaire :  Numéro du reçu :</h1>
            <table className="w-[1300px]  mt-[50px] text-center  ">
                <tbody>
                    <tr>
                        <td className="border border-black px-4 py-10">ID étudiant : </td>
                        <td className="border border-black "><input type="number" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                        <td className="border border-black px-4 py-10">Montant payé :</td>
                        <td className="border border-black "><input type="number" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                    </tr>
                    <tr>
                        <td className="border border-black px-4 py-10">Nom : </td>
                        <td className="border border-black "><input type="text" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                        <td className="border border-black px-4 py-10">Mode de paiement :</td>
                        <td className="border border-black "><input type="text" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                    </tr> 
                    <tr>
                        <td className="border border-black px-4 py-10">Prénom :</td>
                        <td className="border border-black "><input type="text" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                        <td className="border border-black px-4 py-10">Numéro de chèque :</td>
                        <td className="border border-black "><input type="number" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                    </tr>
                    <tr>
                        <td className="border border-black px-4 py-10">Niveau :</td>
                        <td className="border border-black "><input type="text" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                        <td className="border border-black px-4 py-10">Au nom de :</td>
                        <td className="border border-black "><input type="text" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                    </tr>
                    <tr>
                        <td className="border border-black px-4 py-10">Libellé :</td>
                        <td className="border border-black "><input type="text" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                        <td className="border border-black px-4 py-10"> Banque :</td>
                        <td className="border border-black "><input type="text" placeholder="..." className=" h-[100px] w-full text-xl font-normal pl-4"/></td>
                    </tr>
                </tbody>
            </table>
                
                <div className="ml-[1050px] mt-[20px]">
                    <button href="" className="border py-3 px-6 rounded-[20px] bg-green-500 text-white shadow-2xl ">Submit</button>
                    <button className="border py-3 px-6 rounded-[20px] bg-red-600 text-white shadow-2xl ">Cancel</button>
                </div>
            </div>
      </div>
      </div>
