...
export default function Todo() {
    return ( 
        ...
        <div>
            ...
            <h2 className="text-lg font-semibold mt-[100px]">To Do List</h2>
            <div className="flex mt-4 items-center justify-center">
                <input type="text" placeholder="Add a new task" className="border p-2 flex-grow w-[700px]" />
                <button className="ml-2 bg-blue-500 text-white px-4 py-2">Add</button>
            </div>
