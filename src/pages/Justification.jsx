...
export default function AbsenceStat() {
    return (
      ...
      <ul className=" space-y-2 font-medium  border-gray-200 dark:border-gray-700">
        ...
        <div className=" ml-[600px] mt-[80px]">
      <div className="p-8 bg-white shadow-lg rounded-xl w-[1000px] h-[700px]">
        <h1 className="text-2xl font-semibold mb-6">Justification</h1>
        {/* Date Field */}
        <div className="mb-4">
          ...
          <div className="relative mt-1">
            <input
              type="date"
              id="date"
              className="block w-full px-4 py-2 text-gray-700 bg-gray-50 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
            />
        ...
        <div className="mb-6">
          ...
          <textarea
            id="motif"
            rows="4"
            className="block w-full h-[400px] mt-1 px-4 py-2 text-gray-700 bg-gray-50 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div className="flex justify-end space-x-4">
          <button
            type="button"
            className="inline-flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="inline-flex items-center px-4 py-2 text-white bg-teal-500 rounded-lg hover:bg-teal-600 focus:ring-2 focus:ring-offset-2 focus:ring-teal-400"
          >
            <svg
