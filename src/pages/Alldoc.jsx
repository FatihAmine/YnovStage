...
export default function Alldoc() {
    return (
        ...
        <div class="flex items-center justify-between pb-2 mt-[50px] ml-[450px] mr-[170px]">
            <h1 class="text-[20px] font-semibold">All documents</h1>
            <button class="flex items-center px-4 py-2 bg-teal-500 text-white rounded-lg">
                <span class="mr-2">Filter</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-.293.707L13 13.414V18a1 1 0 01-.553.894l-4 2A1 1 0 017 20v-6.586L3.293 6.707A1 1 0 013 6V4z" />
                </svg>
            </button>
        </div>
        <div className="mt-[40px] ml-[450px]">
                ...
                <tbody>
                    ...
                    .map((_, index) => (
                        ...
                        <td className="p-4 w-4">
                            ...
                            <td className="py-4 px-6">Sample Document {index + 1}</td>
                            <td className="py-4 px-6">John Doe</td>
                            <td className="py-4 px-6">01/10/2024</td>
                            <td className="py-4 px-6">Report</td>
                            <td className="py-4 px-6">02/10/2024</td>
                        </tr>
                    ))}
                    </tbody>
                    </table>
